...
require(frame.get("height", 0) >= 24, "panel height too small")
...
require(bool(codex.get("collapsedStatus")), "missing Codex collapsed status")
usage = codex.get("usage", {})
require(bool(usage.get("summary")), "missing Codex usage summary")
threads = codex.get("threads", {})
require("active" in threads, "missing Codex active thread count")
require("open" in threads, "missing Codex open thread count")
require("terminal" in threads, "missing Codex terminal thread count")
