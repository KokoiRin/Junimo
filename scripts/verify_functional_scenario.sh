...
require("active" in threads, "scenario missing Codex active thread count")
require("open" in threads, "scenario missing Codex open thread count")
require("terminal" in threads, "scenario missing Codex terminal thread count")
