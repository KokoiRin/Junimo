# app-bundle-launch Specification

## Purpose
Define the local scripts and launch evidence that prove Junimo can be built and started as a macOS app bundle without relying on SwiftPM.
## Requirements
