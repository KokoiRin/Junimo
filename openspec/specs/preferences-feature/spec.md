...
## Purpose
Define the Swift preferences feature boundary for UI preference and theme projection while keeping accent, density, panel sizing, and top-offset policy in the core layer.
