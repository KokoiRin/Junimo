# codex-realtime-adapter Specification

## Purpose
Define how Codex app-server notifications and `codex exec --json` lifecycle events update Junimo's Codex monitor without blocking UI rendering.
## Requirements
