# codex-thread-lifecycle Specification

## Purpose
Define the normalized lifecycle semantics Junimo uses to turn Codex app-server,
cloud, and exec observations into stable monitor state, health diagnostics, and
collapsed island status text.
## Requirements
