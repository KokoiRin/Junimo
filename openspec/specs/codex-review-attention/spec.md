# codex-review-attention Specification

## Purpose
Define the persistent in-app attention state that keeps completed or failed Codex results visible until the user acknowledges them.
## Requirements
...
- **AND** the collapsed status cue or count lets the user acknowledge the latest review item
