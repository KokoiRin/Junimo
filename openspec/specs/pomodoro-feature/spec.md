...
## Purpose
Define the Swift Pomodoro feature boundary that projects active timer state and maps core completion results into notification effects while keeping portable timer policy in the core layer.
