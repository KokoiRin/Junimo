# cpp23-core-framework Specification

## Purpose
Define the portable C++23 core foundation that owns long-term domain state while Swift/AppKit owns native desktop presentation.
## Requirements
